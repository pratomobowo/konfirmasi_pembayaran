...
@section('content')
    ...
    <div class="space-y-6">
        ...
        <!-- Aktivitas Terbaru -->
        <div class="bg-white overflow-hidden shadow-sm rounded-lg">
            <div class="px-4 py-3 sm:px-6 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center">
                <h3 class="text-lg font-medium text-gray-900">Aktivitas Terbaru</h3>
                <a href="{{ route('admin.payments') }}" class="mt-1 sm:mt-0 text-sm font-medium text-blue-600 hover:text-blue-800">
                    Lihat Semua
                </a>
            </div>
            <div class="p-4">
