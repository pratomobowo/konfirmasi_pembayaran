    ...
    <div class="py-8 sm:py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-4 sm:mt-6 flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mb-6 sm:mb-10">
                <a href="{{ route('payment.create') }}" class="w-full sm:w-auto inline-flex justify-center items-center px-4 sm:px-6 py-2 sm:py-3 border border-transparent rounded-md shadow-sm text-sm sm:text-base font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 sm:h-5 sm:w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                    </svg>
                    Upload Bukti Pembayaran
                </a>
                <a href="{{ route('payment.track') }}" class="w-full sm:w-auto inline-flex justify-center items-center px-4 sm:px-6 py-2 sm:py-3 border border-blue-600 rounded-md shadow-sm text-sm sm:text-base font-medium text-blue-600 bg-white hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 sm:h-5 sm:w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="mt-6 sm:mt-10">
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8">
                    <!-- Step 1 -->
                    <div class="bg-gray-50 rounded-lg p-4 sm:p-6 border border-gray-200 shadow-sm text-center">
                        <div class="bg-blue-100 rounded-full h-10 w-10 sm:h-12 sm:w-12 flex items-center justify-center mx-auto mb-3 sm:mb-4">
                ...
                <div class="p-4 sm:p-6 text-gray-900">
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 sm:mb-6 space-y-3 sm:space-y-0">
                        ...
                        <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
                            <a href="{{ route('payment.create') }}" class="w-full sm:w-auto inline-flex justify-center items-center px-3 sm:px-4 py-2 bg-blue-600 text-white text-sm rounded hover:bg-blue-700 transition">
                                Upload Bukti
                            </a>
                            <a href="{{ route('payment.track') }}" class="w-full sm:w-auto inline-flex justify-center items-center px-3 sm:px-4 py-2 bg-green-600 text-white text-sm rounded hover:bg-green-700 transition">
                                Cek Status
                            </a>
                        </div>
                    </div>
                                            ...
                                            @foreach($payments as $payment)
                                                <tr>
                                                    ...
                                                    <td class="px-3 sm:px-6 py-2 sm:py-4 whitespace-nowrap">
                                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $payment->status_badge }}">
                                                            {{ $payment->status_text }}
                                                        </span>
                                                    </td>
