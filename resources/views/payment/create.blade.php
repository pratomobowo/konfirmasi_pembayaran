                    ...
                    <div class="mb-8 hidden md:block">
                        <div class="flex items-center">
                            <div class="flex items-center relative">
                                <div class="rounded-full h-12 w-12 flex items-center justify-center bg-blue-600 text-white text-lg font-semibold">
                                    1
                                </div>
                                <div class="absolute top-0 -ml-4 text-xs mt-14 w-32 text-center">
                                    <span class="text-blue-600 font-semibold">Isi Data</span>
                                </div>
                            </div>
                            <div class="flex-1 border-t-2 border-blue-600"></div>
                            <div class="flex items-center relative">
                                <div class="rounded-full h-12 w-12 flex items-center justify-center bg-gray-300 text-gray-600 text-lg font-semibold">
                                    2
                                </div>
                                <div class="absolute top-0 -ml-4 text-xs mt-14 w-32 text-center">
